...
export default function RestaurantDetailPage() {
  const menuCategories = [
    { id: 1, name: 'Appetizer', icon: 'restaurant-outline' },
    { id: 2, name: 'Starter', icon: 'leaf-outline' },
    { id: 3, name: 'Main', icon: 'restaurant-outline' },
    { id: 4, name: 'Dessert', icon: 'ice-cream-outline' },
    { id: 5, name: 'Drink', icon: 'cafe-outline' },
  ];
